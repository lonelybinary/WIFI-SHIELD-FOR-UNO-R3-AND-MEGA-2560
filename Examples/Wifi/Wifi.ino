...
#define WIFI_SSID        "lonelybinary" //WIFI SSID
#define WIFI_PASS        "0987654321" // Wifi Password
#define SERVER_IP     "142.250.66.195" // Google's IP Address
...
void setup()
{
  ...
  cmd = "GET /";//Path to the target server file.
